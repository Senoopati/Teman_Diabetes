...
WebUI.callTestCase(findTestCase('Rekaman/Add Gula Darah/Sebelum Makan Siang/TC05_OnlyFillJenisPemeriksaanWaktuAndGulaDarah'), 
...
Mobile.verifyEqual(messageError, 'Snack Pagi tidak boleh kosong')
