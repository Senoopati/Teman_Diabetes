...
WebUI.callTestCase(findTestCase('Rekaman/Add Gula Darah/Sebelum Makan Siang/TC03_OnlyFillJenisPemeriksaanAndOverTimeNow'), 
...
Mobile.verifyEqual(messageError, 'Gula darah tidak boleh kosong\nSarapan tidak boleh kosong\nSnack Pagi tidak boleh kosong')
